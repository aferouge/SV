...
\begin{center}
\begin{tabular}{l r}
Date Performed: & January, 2013 \\ % Date the experiment was performed
...
\include{Sections/Translations}
\include{Sections/Modeling}
\include{Sections/Checks}
...
\include{Sections/MCRL}
\include{Sections/MCF}
